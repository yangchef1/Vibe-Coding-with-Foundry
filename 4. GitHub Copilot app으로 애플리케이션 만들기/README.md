...
- 추천 탭에 "대성정공 예시 불러오기" 버튼을 두고 부산 강서구, 자동차부품 제조 매출 65%, 업력 6년 2개월, 12명, 매출 24억원, CNC 설비 공급가 3억원, 희망 2억원, 첫 신청, 체납 및 연체 없음, 계약 1개월 전, 임차공장, NICE B를 자동 입력
...
- BNK Red를 활성 탭, 주요 CTA 버튼, 텍스트 강조와 아이콘에 일관되게 사용하고, 넓은 화이트 여백과 다크 그레이 및 라이트 그레이 보조색으로 신뢰감과 안정감 표현. 과도한 장식, 그라데이션, 중첩 카드는 사용하지 않기
...
- 의견서 결과에서 `PDF 저장` 버튼을 누르면 A4 의견서만 인쇄할 수 있습니다.
...
- 기존 예시 불러오기, Markdown 렌더링, 의견서 PDF 저장, UI와 인쇄 스타일은 유지하기
